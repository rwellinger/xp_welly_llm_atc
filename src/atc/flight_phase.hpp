...
struct IfrDefaults {
  ...
  // Approximately the TMA upper boundary. 0 = use cruise FL - 2000 ft as
  // fallback.
  int radar_handoff_alt_ft = 0;
  // Altitude stated in the takeoff clearance: "passing Xft, contact Approach on
...
// IFR defaults (initial altitude, squawk range) loaded from
// ifr/flight_rules.json.
